...
// AddBytesValid provides a mock function with given fields: key, value
func (_m *ObjectEncoder) AddBytesValid(key string, value []byte) {
	_m.Called(key, value)
}
...
// AddObjectValid provides a mock function with given fields: key, marshaler
func (_m *ObjectEncoder) AddObjectValid(key string, marshaler zapcore.ObjectMarshaler) {
	_m.Called(key, marshaler)
}
...
// AddStringValid provides a mock function with given fields: key, value
func (_m *ObjectEncoder) AddStringValid(key string, value string) {
	_m.Called(key, value)
}

// AddStrings provides a mock function with given fields: key, value
func (_m *ObjectEncoder) AddStrings(key string, value []string) {
	_m.Called(key, value)
}

// AddStringsValid provides a mock function with given fields: key, value
func (_m *ObjectEncoder) AddStringsValid(key string, value []string) {
	_m.Called(key, value)
}
